...
-- إدراج المشاريع
INSERT INTO projects (name, type, description, total_budget, spent_amount, start_date, end_date, status, created_at, updated_at) VALUES
('مسلسل الأحلام الذهبية - رمضان 2025', 'series', 'مسلسل درامي اجتماعي من 30 حلقة يتناول قضايا المجتمع المعاصر', 15000000, 8500000, '2024-09-15', '2026-02-15', 'active', NOW(), NOW()),
('برنامج صباح الخير يا عرب', 'program', 'برنامج صباحي يومي يقدم الأخبار والترفيه', 5000000, 3200000, '2024-06-15', '2025-06-15', 'active', NOW(), NOW()),
('فيلم الرحلة الأخيرة', 'movie', 'فيلم سينمائي درامي يحكي قصة عائلة في زمن الحرب', 8000000, 7800000, '2024-04-15', '2024-11-15', 'completed', NOW(), NOW()),
('مسلسل حكايات الأطفال', 'series', 'مسلسل تعليمي للأطفال من 20 حلقة', 3000000, 1200000, '2025-01-15', '2025-04-15', 'planning', NOW(), NOW());
